...
print "<title>$row[0] | HISTORY</title>";
...
$sql = mysql_query("SELECT description_clan_setting FROM tb_clan_setting WHERE name_clan_setting='clan_history_rewards'") or die (mysql_error());
$row = mysql_fetch_row($sql);
print $row[0];
...
$sql = mysql_query("SELECT description_clan_setting FROM tb_clan_setting WHERE name_clan_setting='clan_history_clan'") or die (mysql_error());
$row = mysql_fetch_row($sql);
print $row[0];
